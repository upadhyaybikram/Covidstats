...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView mtodaytoal,mtotal,mactive,mtodayactive,mrecovered,mtodayrecovered,mdeaths,mtodaydeaths;
    ...
    com.example.covidstats.Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mtodaytoal = findViewById(R.id.todaytotal);
            ...
            public void onResponse(Call<List<ModelClass>> call, Response<List<ModelClass>> response) {
                ...
                for (int i = 0;i<modelClassList.size();i++)
                {
                    if(modelClassList.get(i).getCountry().equals(country))
                    {
                        ...
                        mtodaytoal.setText(modelClassList.get(i).getTodayCases());
